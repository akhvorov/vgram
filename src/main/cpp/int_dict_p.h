...
public:
    ...
    int search(const std::vector<int>& seq, const std::vector<int>* excludes = nullptr) const override;
...
private:
    ...
    int linearParse(const std::vector<int>& seq, std::vector<int>* builder, const std::unordered_set<int>* excludes = nullptr);
